...
static const u8 sText_PkmnMakesGroundMiss[] = _("因为{B_DEF_ABILITY}，地面属性的招式\n无法击中{B_DEF_NAME_WITH_PREFIX}！");
...
static const u8 sText_PkmnPoisonedBy[] = _("因{B_SCR_ACTIVE_ABILITY}的{B_EFF_NAME_WITH_PREFIX}，\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}中毒了！");
...
static const u8 sText_PkmnInLove[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}让\n{B_ATK_NAME_WITH_PREFIX}着迷了！");
...
static const u8 sText_PkmnRaisedSpDefALittle[] = _("{B_CURRENT_MOVE}使{B_ATK_PREFIX2}的\n特殊抗性略微提高了！");
static const u8 sText_PkmnRaisedDef[] = _("{B_ATK_PREFIX2}'s {B_CURRENT_MOVE}\nraised DEFENSE!");
static const u8 sText_PkmnRaisedDefALittle[] = _("{B_CURRENT_MOVE}使{B_ATK_PREFIX2}的\n物理抗性略微提高了！");
...
static const u8 sText_PkmnClamped[] = _("{B_DEF_NAME_WITH_PREFIX}\n被{B_ATK_NAME_WITH_PREFIX}的贝壳夹住了！");
...
static const u8 sText_PkmnStayedAwakeUsing[] = _("因为{B_DEF_ABILITY}，\n{B_DEF_NAME_WITH_PREFIX}不会睡着！");
...
static const u8 sText_PkmnRaisedSpeed[] = _("因为{B_SCR_ACTIVE_ABILITY}，{B_SCR_ACTIVE_NAME_WITH_PREFIX}的\n速度提高了！");
...
static const u8 sText_PkmnRestoredHPUsing[] = _("因{B_DEF_ABILITY}，{B_DEF_NAME_WITH_PREFIX}的\n体力回复了！");
static const u8 sText_PkmnsXMadeYUseless[] = _("因{B_DEF_NAME_WITH_PREFIX}的{B_DEF_ABILITY}，\n{B_CURRENT_MOVE}无效了！");
static const u8 sText_PkmnChangedTypeWith[] = _("因为{B_DEF_ABILITY}，{B_DEF_NAME_WITH_PREFIX}\n变成了{B_BUFF1}属性！");
static const u8 sText_PkmnPreventsParalysisWith[] = _("因为{B_DEF_ABILITY}，{B_EFF_NAME_WITH_PREFIX}\n不会麻痹！");
static const u8 sText_PkmnPreventsRomanceWith[] = _("因为{B_DEF_ABILITY}，{B_DEF_NAME_WITH_PREFIX}\n不会着迷！");
static const u8 sText_PkmnPreventsPoisoningWith[] = _("因为{B_DEF_ABILITY}，{B_EFF_NAME_WITH_PREFIX}\n不会中毒！");
static const u8 sText_PkmnPreventsConfusionWith[] = _("因为{B_DEF_ABILITY}，{B_DEF_NAME_WITH_PREFIX}\n不会混乱！");
static const u8 sText_PkmnRaisedFirePowerWith[] = _("{B_DEF_NAME_WITH_PREFIX}因{B_DEF_ABILITY}\n提高了火属性招式的威力！");
static const u8 sText_PkmnAnchorsItselfWith[] = _("{B_DEF_NAME_WITH_PREFIX}\n用吸盘吸住了！");
...
static const u8 sText_PkmnPreventsStatLossWith[] = _("因为{B_SCR_ACTIVE_ABILITY}，{B_SCR_ACTIVE_NAME_WITH_PREFIX}的\n能力不会降低！");
...
static const u8 sText_PkmnsXPreventsBurns[] = _("因为{B_EFF_ABILITY}，{B_EFF_NAME_WITH_PREFIX}\n不会灼伤！");
static const u8 sText_PkmnsXBlocksY[] = _("因为{B_DEF_ABILITY}，{B_DEF_NAME_WITH_PREFIX}\n抵御了{B_CURRENT_MOVE}！");
static const u8 sText_PkmnsXBlocksY2[] = _("因为{B_SCR_ACTIVE_ABILITY}，{B_SCR_ACTIVE_NAME_WITH_PREFIX}\n抵御了{B_CURRENT_MOVE}！");
static const u8 sText_PkmnsXRestoredHPALittle2[] = _("因为{B_ATK_ABILITY}，{B_ATK_NAME_WITH_PREFIX}\n回复了少许HP。");
...
static const u8 sText_PkmnsXPreventsYLoss[] = _("因为{B_SCR_ACTIVE_ABILITY}，{B_SCR_ACTIVE_NAME_WITH_PREFIX}的\n{B_BUFF1}不会降低！");
...
static const u8 sText_PkmnsXCuredYProblem[] = _("因为{B_SCR_ACTIVE_ABILITY}，{B_SCR_ACTIVE_NAME_WITH_PREFIX}的\n{B_BUFF1}状态治愈了！");
...
static const u8 sText_PkmnsXTookAttack[] = _("因为{B_DEF_ABILITY}，{B_DEF_NAME_WITH_PREFIX}\n吸引了攻击！");
...
static const u8 sText_PkmnsXPreventsFlinching[] = _("因为{B_EFF_ABILITY}，{B_EFF_NAME_WITH_PREFIX}\n不会畏缩！");
...
static const u8 sText_PkmnsXCuredItsYProblem[] = _("因为{B_SCR_ACTIVE_ABILITY}，{B_SCR_ACTIVE_NAME_WITH_PREFIX}的\n{B_BUFF1}状态治愈了！");
...
static const u8 sText_UsingItemTheStatOfPkmnRose[] = _("因为{B_LAST_ITEM}，{B_SCR_ACTIVE_NAME_WITH_PREFIX}的\n{B_BUFF1}{B_BUFF2}");
...
static const u8 sText_PkmnsItemRestoredPP[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}用{B_BUFF1}\n回复了{B_LAST_ITEM}的PP！");
