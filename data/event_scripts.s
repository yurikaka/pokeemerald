...
gText_PokemonTrainerSchoolEmail::
	.string "有一封宝可梦训练家\n"
	.string "学校来的电子邮件。\p…… …… ……\p1只宝可梦最多可以学4个招式。\p训练家的专业程度就可以从其\n"
...
gText_ComeBackWithSecretPower::
	.string "你知道招式学习器秘密之力吗？\p我们这些人都喜欢\n"
	.string "招式学习器秘密之力。\p我们的成员之一会把它送给你，\n"
	.string "拿到之后就回来给我看看吧。\p我们会让你成为我们之中的一员，\n"
	.string "还可以秘密卖给你些道具。$"

gText_PokerusExplanation::
	.string "交给我的宝可梦\n"
	.string "似乎附上了宝可病毒。\p详细情况不太清楚，\n"
	.string "不过据说，所谓宝可病毒是一种\l附着在宝可梦身上的微小生命体。\p而且在病毒附着期间\n"
	.string "宝可梦好像会成长得特别快。$"
